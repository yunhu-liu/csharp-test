...
namespace KiwiSaverCalculatorTesting.Tests
{
    class IconInfoCheckTest: BasePage
    {
        ...
        {
            String expectedCurrentAgeInfo = "This calculator has an age limit of 18 to 64 years old.";
            utils.ClickInIframe(Driver, employedCalculatorPage.EleCurrentAgeInfoIcon);
            Assert.IsTrue(Driver.PageSource.Contains(expectedCurrentAgeInfo));
        ...
        public void EmploymentStatusInfoCheck()
        {
            ...
            Assert.IsTrue(Driver.PageSource.Contains(expectedEmploymentStatusInfo));
        ...
        public void SalaryPerYearInfoCheck()
        {
            ...
            Assert.IsTrue(Driver.PageSource.Contains(expectedSalaryPerYearInfo));
        ...
        public void KiwiSaverMemberContributionInfoCheck()
        {
            ...
            Assert.IsTrue(Driver.PageSource.Contains(expectedKiwiSaverMemberContributionInfo));
        ...
        public void CurrentKiwiSaverBalanceInfoCheck()
        {
            ...
            Assert.IsTrue(Driver.PageSource.Contains(expectedCurrentKiwiSaverBalanceInfo));
        ...
        public void VoluntaryConditionsInfoCheck()
        {
            ...
            Assert.IsTrue(Driver.PageSource.Contains(expectedVoluntaryConditionsInfo));
